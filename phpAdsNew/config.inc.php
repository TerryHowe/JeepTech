...
// Database username
$phpAds_config['dbuser'] = 'jeeptech_phpads';

// Database password
$phpAds_config['dbpassword'] = 'cd8937fm';

// Database name
$phpAds_config['dbname'] = 'jeeptech_phpadsdb';
...
$phpAds_config['url_prefix'] = 'http://www.jeeptech.com/phpAdsNew';
...
$phpAds_config['log_beacon'] = false;
...
$phpAds_config['warn_admin'] = false;

// E-mail client when clicks/views get low?
$phpAds_config['warn_client'] = false;
...
$phpAds_config['default_banner_url'] = 'http://www.jeeptech.com/phpAdsNew/tiptopbanner.jpg';
$phpAds_config['default_banner_target'] = 'http://www.tiptoprockracing.com';
...
// click logging.
$phpAds_config['type_html_auto'] = false;
