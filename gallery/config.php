 ...
 */
$gallery->setConfig('setup.password', 'saur%5');
 ...
 */
$gallery->setConfig('data.gallery.base', '/var/www/gallery/JTgallery/');
...
$storeConfig['database'] = 'JTgallery';
$storeConfig['username'] = 'gallery';
$storeConfig['password'] = 'pixel';
$storeConfig['tablePrefix'] = 'JTG_';
